...
var zitate = [
    ...
    { zitat: 'E.T. nach Hause telefonieren.', autor: 'Johann Wolfgang Goethe', },
    { zitat: 'Die nennen mich ‚Mr.‘ Tibbs!', autor: 'Donald Trump', },
    { zitat: 'Ich hab\'s geschafft, Ma! Jetzt bin ich ganz oben!', autor: 'Wladimir Wladimirowitsch Putin', },
    { zitat: 'Ich bin fuchsteufelswild und lass mir das nicht mehr länger gefallen.', autor: 'Peter Finch',},
    { zitat: 'Ich werd zu alt für den Scheiß!', autor: 'Humphrey Bogart', },
    { zitat: 'YEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEET', autor: 'Anthony Hopkins', },
    ...
    { zitat: 'Wenn ich gehe, hast du Pause!', autor: 'Dustin Hoffman', },
    { zitat: 'Smoke Weed Everyday', autor: 'Lea Ost', },
    { zitat: 'Sie können die Wahrheit doch gar nicht ertragen!', autor: 'Jack Nicholson', },
    { zitat: 'Ich will allein sein!', autor: 'Loris Balcke', },
    { zitat: 'Morgen ist auch noch ein Tag!', autor: 'Vivien Leigh', },
    { zitat: 'Verhaften Sie die üblichen Verdächtigen!', autor: 'Claude Rains', },
    { zitat: 'Ich will genau das, was sie hatte.', autor: 'Snoop Dog', },
    { zitat: 'Sie werden ein größeres Boot brauchen.', autor: 'Roy Scheider', },
